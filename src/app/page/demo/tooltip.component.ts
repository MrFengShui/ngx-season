...
export class DemoTooltipPageComponent {
    ...
    protected list: Array<{ color: NGXSeasonColorPalette, label: string }> = [
        { color: 'default', label: '默认提示框' },
        { color: 'primary', label: '主要提示框' },
        { color: 'accent', label: '强调提示框' },
        { color: 'success', label: '成功提示框' },
        { color: 'warning', label: '警告提示框' },
        { color: 'failure', label: '失败提示框' },
        { color: 'info', label: '信息提示框' },
        { color: 'help', label: '帮助提示框' },
    ];
