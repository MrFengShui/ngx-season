...
import { OctopusDetailModule } from "src/app/components/detail/detail.module";
...
import { OctopusRollModule } from "src/app/components/roll/roll.module";
import { OctopusScoreModule } from "src/app/components/score/score.module";
...
import { DemoDetailView } from "./detail.component";
...
import { DemoRollView } from "./roll.component";
import { DemoScoreView } from "./score.component";
...
const DEMO_ROUTERS: Routes = [
    ...
    { path: 'chip', component: DemoChipView, data: { breadcrumb: 'Chip' } },
    { path: 'detail', component: DemoDetailView, data: { breadcrumb: 'Detail' } },
    ...
    { path: 'roll', component: DemoRollView, data: { breadcrumb: 'Roll' } },
    { path: 'score', component: DemoScoreView, data: { breadcrumb: 'Score' } }
];
