import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, HostBinding, HostListener, Input, OnDestroy, OnInit, Output, Renderer2, ViewChild } from "@angular/core";
...
export class WidgetsVideoPlayerComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    listenFullscreenStateChange(event: Event): void {
        ...
        if (this.isFullscreen) {
            this.render.addClass(this.box.nativeElement, 'maximum');
        } else {
            this.render.removeClass(this.box.nativeElement, 'maximum');
        }
    }
    ...
    private enterFullscreen(): void {
        const enterRequest = document.body as HTMLElement & {
