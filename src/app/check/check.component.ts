...
@Component({
    ...
    template: `
        <label [attr.for]="id" class="octo-check-box-wrapper" [class.active]="checked || unknown"
               [style.flex-direction]="position === 'after' ? 'row' : 'row-reverse'">
            <span class="octo-check-input" [class.ml-50]="position === 'before'" [class.mr-50]="position === 'after'">
            ...
            <span class="octo-check-label" [class.ml-50]="position === 'after'" [class.mr-50]="position === 'before'">
...
@Component({
    ...
    template: `
        <label [attr.for]="id" class="octo-check-toggle-wrapper" [class.active]="checked"
               [style.flex-direction]="position === 'after' ? 'row' : 'row-reverse'">
            <span class="octo-check-input" [class.ml-50]="position === 'before'" [class.mr-50]="position === 'after'">
